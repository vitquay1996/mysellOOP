										...
										<tbody>
											...
											foreach ($User1 as $User3) {
												...
												<tr>
													...
													<td><?php echo $User3->date;?></td>
													<td><a href='userTable.php?deluser=<?php echo $User3->id;?>' class="btn btn-danger btn-xs" role="button">DELETE</a></td>
												</tr>
												<?php }?>
											</tbody>
										</table>
